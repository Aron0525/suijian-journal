...
assert.equal(version.versionName, '1.1.0');
...
assert.equal(manifest.apkUrl, 'https://aron0525.github.io/suijian-journal/downloads/suijian-android-v1.1.0.apk');
assert.equal(manifest.checksum, createHash('sha256').update(apkBytes).digest('hex'));
assert.equal(await readFile(join(outputPath, 'downloads', 'suijian-android-v1.1.0.apk'), 'utf8'), apkBytes.toString());
