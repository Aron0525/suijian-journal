...
assert.match(index, /id="admin-user-query"/);
assert.match(index, /id="admin-user-status-filter"/);
assert.match(index, /id="admin-clear-user-filters"/);
...
assert.match(index, /id="admin-audit-list"/);
assert.doesNotMatch(index, /id="admin-raw-data"/);
...
assert.match(styles, /\.admin-list-filters/);
assert.match(styles, /\.admin-user-metrics/);
...
assert.match(app, /function filteredAdminUsers\(\)/);
assert.match(app, /adminUserQuery/);
assert.match(app, /adminUserStatusFilter/);
assert.match(app, /adminAuditList/);
...
assert.match(app, /adminRequest\('record_export'/);
...
assert.match(edge, /function userActivityStats\(/);
assert.match(edge, /entry_count/);
assert.match(edge, /attachment_bytes/);
...
assert.match(edge, /record_export/);
assert.match(edge, /audit_events/);
