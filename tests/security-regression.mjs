...
assert.match(serviceWorker, /suijian-pwa-v32/);
assert.match(index, /app\.js\?release=20260822-account-ai-sync/);
...
assert.match(app, /sw\.js\?release=20260822-account-ai-sync/);
