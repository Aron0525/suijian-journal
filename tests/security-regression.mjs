...
assert.match(serviceWorker, /suijian-pwa-v39/);
assert.match(index, /app\.js\?release=20260901-public-app-sync/);
...
assert.match(app, /sw\.js\?release=20260901-public-app-sync/);
