...
assert.match(serviceWorker, /suijian-pwa-v22/);
assert.match(index, /app\.js\?release=20260811-auto-sync-layout/);
...
assert.match(app, /sw\.js\?release=20260811-auto-sync-layout/);
