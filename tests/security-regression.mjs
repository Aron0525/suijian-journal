...
assert.match(serviceWorker, /suijian-pwa-v47/);
assert.match(index, /app\.js\?release=20260909-admin-console-v2/);
...
assert.match(app, /sw\.js\?release=20260909-admin-console-v2/);
