...
assert.match(serviceWorker, /suijian-pwa-v28/);
assert.match(index, /app\.js\?release=20260813-sync-compat-v111/);
...
assert.match(app, /sw\.js\?release=20260813-sync-compat-v111/);
