...
assert.match(serviceWorker, /suijian-pwa-v36/);
assert.match(index, /app\.js\?release=20260830-sync-recovery/);
...
assert.match(app, /sw\.js\?release=20260830-sync-recovery/);
