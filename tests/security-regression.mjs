...
assert.match(serviceWorker, /suijian-pwa-v34/);
assert.match(index, /app\.js\?release=20260825-optional-entry-details/);
...
assert.match(app, /sw\.js\?release=20260825-optional-entry-details/);
