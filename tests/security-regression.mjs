...
assert.match(serviceWorker, /suijian-pwa-v52/);
assert.match(index, /app\.js\?release=20260910-mobile-recovery-v3/);
...
assert.match(app, /sw\.js\?release=20260910-mobile-recovery-v3/);
...
assert.match(mobileVersion, /"versionCode": 7/);
assert.match(mobileVersion, /"versionName": "1\.1\.5"/);
