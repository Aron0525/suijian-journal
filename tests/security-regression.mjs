...
assert.match(serviceWorker, /suijian-pwa-v43/);
assert.match(index, /app\.js\?release=20260904-full-account-sync/);
...
assert.match(app, /sw\.js\?release=20260904-full-account-sync/);
