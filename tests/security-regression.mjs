...
assert.match(serviceWorker, /suijian-pwa-v38/);
assert.match(index, /app\.js\?release=20260901-mobile-natural-scroll/);
...
assert.match(app, /sw\.js\?release=20260901-mobile-natural-scroll/);
