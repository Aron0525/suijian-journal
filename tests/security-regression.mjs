...
assert.match(serviceWorker, /suijian-pwa-v33/);
assert.match(index, /app\.js\?release=20260824-ai-suggestion-diff/);
...
assert.match(app, /sw\.js\?release=20260824-ai-suggestion-diff/);
