...
assert.match(serviceWorker, /suijian-pwa-v30/);
assert.match(index, /app\.js\?release=20260822-account-login-gate/);
...
assert.match(app, /sw\.js\?release=20260822-account-login-gate/);
