...
assert.match(serviceWorker, /suijian-pwa-v50/);
assert.match(index, /app\.js\?release=20260910-admin-data-v1/);
...
assert.match(app, /sw\.js\?release=20260910-admin-data-v1/);
...
assert.match(mobileVersion, /"versionCode": 6/);
assert.match(mobileVersion, /"versionName": "1\.1\.4"/);
