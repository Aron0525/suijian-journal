...
assert.match(serviceWorker, /suijian-pwa-v41/);
assert.match(index, /app\.js\?release=20260902-cloud-draft-fallback/);
...
assert.match(app, /sw\.js\?release=20260902-cloud-draft-fallback/);
