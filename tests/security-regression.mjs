...
assert.match(serviceWorker, /suijian-pwa-v35/);
assert.match(index, /app\.js\?release=20260825-prompt-workflow/);
...
assert.match(app, /sw\.js\?release=20260825-prompt-workflow/);
