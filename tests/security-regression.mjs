...
assert.match(serviceWorker, /suijian-pwa-v27/);
assert.match(index, /app\.js\?release=20260812-archive-entry-tags/);
...
assert.match(app, /sw\.js\?release=20260812-archive-entry-tags/);
