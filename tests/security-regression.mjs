...
assert.match(serviceWorker, /suijian-pwa-v44/);
assert.match(index, /app\.js\?release=20260906-full-sync-inventory/);
...
assert.match(app, /sw\.js\?release=20260906-full-sync-inventory/);
