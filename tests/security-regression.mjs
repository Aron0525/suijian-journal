...
assert.match(serviceWorker, /suijian-pwa-v31/);
assert.match(index, /app\.js\?release=20260822-account-recovery/);
...
assert.match(app, /sw\.js\?release=20260822-account-recovery/);
