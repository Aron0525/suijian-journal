...
assert.match(serviceWorker, /suijian-pwa-v29/);
assert.match(index, /app\.js\?release=20260813-open-auto-update/);
...
assert.match(app, /sw\.js\?release=20260813-open-auto-update/);
